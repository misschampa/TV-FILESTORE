...
from ERASTORE.utils.human_readable import humanbytes
from ERASTORE.utils.file_properties import get_file_ids
from ERASTORE.server.exceptions import InvalidHash
import urllib.parse
import logging
import aiohttp
...
async def render_page(id, secure_hash, src=None):
    ...
    if tag in ["video", "audio"]:
        template_file = "ERASTORE/template/req.html"
    else:
        template_file = "ERASTORE/template/dl.html"
